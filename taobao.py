...
class UsernameLogin:
    ...
    def EnterShoppingCart(self) -> None:
        headers = {
...
if __name__ == '__main__':
    ...
    loginId = '13798053640'
    # 改版后增加的参数，后面考虑解密这个参数
    umidToken = '875e6c84f34e9f4ce97a0dfdbabef128a1519f22',
    # 淘宝重要参数，从浏览器或抓包工具中复制，可重复使用
    ua = '125#cF7caTB8cWQNiKuT5AN5lfdSuDf2r14YEXzdh0wkDDIBzbmFt9B4n9FsK04n0Z5fPop85QuM8bMNhjeO0dQ/+fJmRfRFmcR4IDY' \
         'pfeJVSUb8hi4XJWp7B86guIrTxcrJzzdxBOAFVw4AxmoGSYBfWdFwZg4bBMDZES80e85OzhEhDE0pB9eIzEm4Nezii2HzHBiqj9f/CtLP' \
         'aliLDz6b3B9gtGB1ch5JfeDSHLD5BHhYFyQ0F/NDIJXulO6/6HH7RvDxwRTBFoovzOq6H7i6tKCdJTomfiObccscKJsScUHUcNOQbghhvb' \
         'DwcLU5haVCU6syKMHacb/YGNyjEaVrUmn+fojwfFvbimESkJEccUb7cqy70g4nFEuKhG6FNeVZAeStd4WxAKbVt9qEs6eO4P2xX50ivpu9' \
         'zaozXw52aIts4THZDwTIioKEyVrtD8sTo+11Ucer2K2zs+Sx6jHNwpt8sYNfabbh6gh33gp42aQoxcA06aIwNJClCxLS0vNW6omKoj+7RV' \
         'g0LmW5G6fy2GFzSSwKxn3D1PSRewCCIyhKU2HJgEtI5xO8YEUqOVFmfIVbxs1voW0YMXyvllUKVt1dNRTDQ3numyA8Vu/ELUuEdBt8L5zp' \
         'oKqABwkhBRNg3msokr6VfNG7w4uf0eIIZ1S0BMfqPUxJCZn1XQP/11a9iWZQWz7NbocE7vTU76xfmP3DzlK8FSod5+FAckWrt4a8imw8ME' \
         'vNyLuhPpiGiaSGFbBz+31COgOUyt+1bZdHsHyPIsLE5I/Q6ArmNSX0f2nJIs9D7JAFAeTZV0EOrZI0v0YQze8yLAkFsexT+SboipKywSAZ' \
         'J90pnl1nDQdEZwiMXi0cYuadNjEtwtFOEuAgr+wOmKpJ4q+guBE1DR8tCFp8SduLpTgbKeCWch82QomdrZYBvAcVyfkPzwuUPHVSqSw2G9' \
